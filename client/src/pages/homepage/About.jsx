    ...
    <>
      ...
      <div className="p-3">
        ...
        <p>
          ...
          user-centric application designed to revolutionize how professionals
        ...
        <ol>
          <li>
            ...
            <p>
              Worknado boasts an intuitive interface that makes job searching a
              breeze. Users can swiftly navigate through a vast array of job
              listings, filter options, and personalized recommendations,
              ensuring a tailored experience for every individual.
            </p>
          </li>
          <li>
            <h3>Tailored Opportunities:</h3>
            <p>
              Say goodbye to endless scrolling. Worknado utilizes cutting-edge
              algorithms to match users with opportunities that align not just
              with their skills but also with their aspirations and values.
              It&apos;s about finding the right fit, not just any job.
            </p>
          </li>
        </ol>
      </div>
